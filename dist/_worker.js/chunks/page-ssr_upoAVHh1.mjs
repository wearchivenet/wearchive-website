...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import('./stegaEncodeSourceMap_D8ple0Oh.mjs').then(function(n) {
...
const pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), eventSourcePolyfill = defer(() => import('./browser_ZcgBU8B3.mjs').then(n => n.b)).pipe(
...
const sanityClient = createClient(
  { "apiVersion": "2025-01-01", "projectId": "your-project-id", "dataset": "production", "useCdn": false }
);

globalThis.sanityClient = sanityClient;

export { isRecord as i, y };
